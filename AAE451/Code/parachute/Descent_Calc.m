function [outputs, data] = Descent_Calc(t, inputs, wind, CD, Aref, m, alt_end, windx)
...
vx_wind = windx; %gs * cosd(gc);  %(m/s) x-axis velocity during this time slice
vy_wind = 0; %gs * sind(gc);  %(m/s) y-axis velocity during this time slice
