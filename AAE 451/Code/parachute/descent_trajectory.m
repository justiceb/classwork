function [ long, lat, sz, data ] = descent_trajectory( long0, lat0, alt0, alt_end, wind, CD, Aref, m, vx0, vy0, windx )
...
[t, outputs] = ode45(@Descent_Calc, timerange, init, options, wind, CD, Aref, m, alt_end, windx);
...
for n = 1:1:length(sz)
    ...
    [~, data] = Descent_Calc(t(n), inputs, wind, CD, Aref, m, alt_end, windx);
    ax(n) = data.ax;
    ay(n) = data.ay;
    az(n) = data.az;
end
