% Step3_Simulink_SimMATLAB6     Version 8.0 1/23/03
%
...
%         time histories.
echo on
% MATLAB 6 users will run
% the nonlinear simulation in SIMULINK using FlatEarth_MATLAB6.mdl.
%
% To bring up Simulink, type simulink from the Matlab command window.
%
% From the Simulink window, use the File Open menu
%   to open the Simulink model  FlatEarth_MATLAB6.mdl.
%
