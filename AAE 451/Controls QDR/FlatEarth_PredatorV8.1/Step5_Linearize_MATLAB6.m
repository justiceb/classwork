% Step5_Linearize_MATLAB6.m    Version 8.0 1/23/03 
%
...
flag=1; t=0;
[xdot] = aircraft7(t,x1,u1,flag,constant,x1);

% Get outputs at the trim condition
flag=3; t=0;
[y1] = aircraft7(t,x1,u1,flag,constant,x1);
...
echo off
[a,b,c,d]=linmod('FlatEarth_ports_MATLAB6',x1,u1) %Find linear model of nonlinear pendulum
