function  [sys,x0,str,ts] = aircraft7(t,x,u,flag,constant,xIC)
%   function [sys,x0,str,ts] = aircraft7(t,x,u,flag,constant,xIC)
%   
%   Version 7.0, 10/9/02 (Includes steady winds)
...
switch flag,      
  ...
  case 3,
      sys=ACOutputs(t,x,u);
      %sys=ACOutputs(t,x,u);  % Compute output vector
...
g= constant(2); mass=constant(3);  S=constant(20); cbar=constant(21);
...
sys = [U,V,W,x(4),x(5),x(6),phi,theta,psi,x(10),...
       x(11),x(12),Vt,alpha,beta,gamma,Xdot,Ydot,Hdot];
