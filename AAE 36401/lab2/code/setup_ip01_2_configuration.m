...
function [ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, M, r_mp, Beq ] = setup_ip01_2_configuration( CART_TYPE, IP02_WEIGHT_TYPE, UPM_TYPE )
% Calculate useful conversion factors
calc_conversion_constants;
% Calculate IP01 or IP02 model parameters
[ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, M, r_mp, Beq ] = calc_IP01_2_parameters( CART_TYPE, IP02_WEIGHT_TYPE, UPM_TYPE );
% end of 'setup_ip01_2_configuration( )'


%% Calculate the IP01 or IP02 model parameters 
function [ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, M, r_mp, Beq ] = calc_IP01_2_parameters( CART_TYPE, IP02_WEIGHT_TYPE, UPM_TYPE )
...
elseif strcmp ( CART_TYPE, 'IP02')
    ...
    K_PC = 0; K_PP = 0;
    if strcmp( IP02_WEIGHT_TYPE, 'NO_WEIGHT')
        M = Mc2;
        Beq = 4.3;
    elseif strcmp ( IP02_WEIGHT_TYPE, 'WEIGHT')
        M = Mc2 + Mw;
        Beq = 5.4;
    else 
